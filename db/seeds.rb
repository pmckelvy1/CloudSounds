...
# real_users = [me, darth, bach, bowie, sophie, grimes, franksinatra, fugees, pitchslap, whatsonot, russ, thedude, theeveningfools, dillonf]
...
rain = Song.create(user_id: guest.id, username: guest.username, title: "Mellow Rain", info: "Relax to the calming sounds of the rain.",
  audio: File.open('app/assets/audio/Rain.m4a'), image: File.open('app/assets/images/rain.jpg'))
cloudsounds = Song.create(user_id: guest.id, username: guest.username, title: "Cloud Sounds!", info: "I love cloudy days...",
  audio: File.open('app/assets/audio/Cloud Sounds 2.m4a'), image: File.open('app/assets/images/clouds.jpg'))
...
#    audio: File.open("app/assets/audio/songs/Blase (Louis The Child Remix).m4a"), image: File.open('app/assets/images/dude-music.jpeg'))
...
#    audio: File.open("app/assets/audio/songs/For The Chance.m4a"), image: File.open('app/assets/images/hazy-sanc.jpeg'))
...
#    audio: File.open("app/assets/audio/songs/Summer Tangerine.m4a"), image: File.open('app/assets/images/hazy-sanc.jpeg'))

# foolssongs = [fools1, fools2]

# # DILLON FRANCIS
# dillon1 = Song.create!(user_id: dillonf.id, username: dillonf.username, title: 'Without You (The Rebirth) [feat. Totally Enormous Extinct Dinosaurs]', info: "Feelin' alright somehow......",
#    audio: File.open("app/assets/audio/songs/Without You (The Rebirth) [feat. Totally Enormous Extinct Dinosaurs].m4a"), image: File.open('app/assets/images/money-sucks.jpg'), num_plays: 234156)
...
#
# dillonsongs = [dillon1, dillon2, dillon3]
...
# darth2 = User.create!(num_songs: 1, email: 'darth_vader2@gmail.com', username: 'Darth Vader2', password: 'starwars', info: "Leader of the Imperial Army, Dark Lord, and Sith Master2", image: File.open('app/assets/images/vader.jpg'))

# Song.destroy_all

#
# imperialmarch = Song.create!(user_id: darth2.id, username: darth2.username, title: "Imperial March", info: "Original music by John Williams.",
# audio: open(URI.encode('https://s3.amazonaws.com/jambox-dev/songs/audios/000/000/014/original/Star_Wars-Imperial_March.mp3')), image: File.open('app/assets/images/vader-army.jpg'))
# imperialmarch = Song.create!(user_id: darth.id, username: darth.username, title: "Imperial March", info: "Original music by John Williams.",
# audio: File.open('app/assets/audio/songs/Star Wars-Imperial March.mp3'), image: File.open('app/assets/images/vader-army.jpg'))
