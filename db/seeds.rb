...
bach = User.create!(num_songs: 3, email: 'johansebass@gmail.com', username: 'Bach', password: 'classical', info: "I play piano.  I also crochet.", image: File.open('app/assets/images/bach_shades.jpg'))
bowie = User.create!(num_songs: 2, email: 'dbowie@gmail.com', username: 'David Bowie', password: 'ziggystardust', info: "Call me ziggy.", image: File.open('app/assets/images/bowie.jpg'))
...
galantis = User.create!(num_songs: 6, email: 'galantis@gmail.com', username: 'Galantis', password: 'catsandcats', info: "App Academy's favorite EDM artist.  Why?  Cats. Thats why.", image: File.open('app/assets/images/galantis_profile.jpg'))
...
whatsonot = User.create!(num_songs: 5, email: 'whatsonot@gmail.com', username: 'What So Not', password: 'whatsonot', info: "Australian beat-making duo.  Flume + Chet Faker.  We tour the world and make you twerk.", image: File.open('app/assets/images/what-so-not-profile'))
...
real_users = [me, darth, bach, bowie, sophie, grimes, franksinatra, fugees, kasbo, galantis, pitchslap, whatsonot, russ]
...
imperialmarch = Song.create!(user_id: darth.id, username: darth.username, title: "Imperial March", info: "Original music by John Williams.",
  audio: File.open('app/assets/audio/Star Wars-Imperial March.m4a'), image: File.open('app/assets/images/vader-army.jpg'))
...
moonlight = Song.create!(user_id: bach.id, username: bach.username, title: "Moonlight Sonata", info: "I wrote this song first.  This is totally not a Beethoven song.",
  audio: File.open('app/assets/audio/Moonlight Sonata 1st Movement.mp3'), image: File.open('app/assets/audio/moonlight.jpg'))
...
# KASBO SONGS
kasbo1 = Song.create!(user_id: galantis.id, username: galantis.username, title: "I Don't Get", info: "UMBRELLA CLUP EP out now.",
  audio: File.open("app/assets/audio/I Don't Get.m4a"), image: File.open('app/assets/images/kasbo_kalide.jpg'), num_plays: 35664)
kasbo1 = Song.create!(user_id: galantis.id, username: galantis.username, title: "There's Something About U", info: "UMBRELLA CLUP EP out now.",
...
kasbo1 = Song.create!(user_id: galantis.id, username: galantis.username, title: "The Tension", info: "UMBRELLA CLUP EP out now.",
  audio: File.open("app/assets/audio/The Tension.m4a"), image: File.open('app/assets/images/kasbo_kalide.jpg'), num_plays: 39525)
...
all_songs = other_songs + ryon_songs + pitchslap_songs + sophie_songs + grimes_songs + galantis_songs + franksinatra_songs + fugees_songs + whatsonot_songs + russ_songs
...
while (i < real_users.length)
  ...
  while (j < num_to_follow)
    ...
    Follow.create!(user_id: real_users[i], followed_id: user.id)
    j += 1
  end
  i += 1
end
...
while (i < robo_users.length)
  ...
  while (j < num_to_follow)
    ...
    Follow.create!(user_id: robo_users[i], followed_id: user.id)
    j += 1
  end
  i += 1
end
...
while (i < real_users.length)
  ...
  while (j < num_to_like)
    ...
    Like.create!(user_id: real_users[i], sond_id: song.id)
    j += 1
  end
  i += 1
end
...
while (i < robo_users.length)
  ...
  while (j < num_to_like)
    what_to_like = Random.rand(all_songs.length)
    song = all_songs[what_to_like]
    Like.create!(user_id: robo_users[i], sond_id: song.id)
    j += 1
  end
  i += 1
end
...
c2 = Comment.create!(user_id: guest.id, song_id: galantis3.id, body: "i love this part")
...
c6 = Comment.create!(user_id: bowie.id, song_id: galantis2.id, body: "great job with this one!")
...
c13 = Comment.create!(user_id: darth.id, song_id: galantis3.id, body: "this must be a joke, right?")
c14 = Comment.create!(user_id: me.id, song_id: galantis3.id, body: "come play a show in NY!")
c15 = Comment.create!(user_id: me.id, song_id: kasbo1.id, body: "when can i get this on itunes?")
...
Comment.create!(user_id: grimes.id, song_id: galantis1.id, body: "i can't get enough of this album!")
Comment.create!(user_id: grimes.id, song_id: galantis2.id, body: "you guys rock!")
Comment.create!(user_id: grimes.id, song_id: whatsonot2.id, body: "oh i love this one!")
Comment.create!(user_id: grimes.id, song_id: whatsonot1.id, body: "funky!")
...
Comment.create!(user_id: kasbo.id, song_id: imperialmarch.id, body: "woah")
Comment.create!(user_id: kasbo.id, song_id: grimes3.id, body: "love this album, girl!")
Comment.create!(user_id: kasbo.id, song_id: fugees2.id, body: "classic album")
...
Comment.create!(user_id: galantis.id, song_id: imperialmarch.id, body: "run for your lives!")
Comment.create!(user_id: galantis.id, song_id: pitchslap2.id, body: "you guys rock!")
Comment.create!(user_id: galantis.id, song_id: russ1.id, body: "oh man it doesn't get much funkier")
Comment.create!(user_id: galantis.id, song_id: kasbo2.id, body: "dude your music is amazing!")
Comment.create!(user_id: russ.id, song_id: galantis3.id, body: "wow!")
...
p2a = PlaylistItem.create!(playlist_id: p2.id, song_id: galantis1.id, song_ord: 0)
...
PlaylistItem.create!(playlist_id: p4.id, song_id: grimes1)
PlaylistItem.create!(playlist_id: p4.id, song_id: grimes2)
PlaylistItem.create!(playlist_id: p4.id, song_id: grimes3)
...
PlaylistItem.create!(playlist_id: p6.id, song_id: whatsonot1)
PlaylistItem.create!(playlist_id: p6.id, song_id: whatsonot2)
PlaylistItem.create!(playlist_id: p6.id, song_id: whatsonot3)
PlaylistItem.create!(playlist_id: p6.id, song_id: whatsonot4)
PlaylistItem.create!(playlist_id: p6.id, song_id: whatsonot5)
